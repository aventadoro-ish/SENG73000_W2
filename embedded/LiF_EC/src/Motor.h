...
constexpr float MM_PER_STEP = 766.8f / 1570.0f; // TODO: set measured conversion
constexpr float MAX_ACCEL_STEPS_S2 = 500.0f;
constexpr float DEFAULT_MOVE_SPEED_STEPS_S = 100.0f;
constexpr float HOMING_SPEED_STEPS_S = 100.0f;
